...
################################################################################
## Form generated from reading UI file 'widget_draw_menu_propertiesAPAfae.ui'
##
...
"QFrame#frame_properties2,\n"
"QFrame#frame_properties1_1,\n"
"QFrame#frame_4{\n"
...
"QFrame#frame_propertiesSubTitle1,\n"
...
"QToolButton#toolButton_cardPropertiesDraw5:pressed,\n"
...
"")
        ...
        self.frame_propertiesProject.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_propertiesProject.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.frame_properties.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_properties.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.label_cardPropertiesTitle.setProperty(u"QLabelStyle", 1)
        ...
        self.frame_propertiesSubTitle1.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_propertiesSubTitle1.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.label_cardPropertiesSubTitle1.setProperty(u"QLabelStyle", 2)
        ...
        self.toolButton_cardPropertiesSubTitle1.setArrowType(Qt.ArrowType.NoArrow)
        self.toolButton_cardPropertiesSubTitle1.setProperty(u"QToolButtonSubTitleStyle", 1)
        ...
        self.frame_properties1.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_properties1.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.label_textProperties1.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(0, QFormLayout.ItemRole.LabelRole, self.label_textProperties1)
        ...
        self.lineEdit_textPropertiesName.setProperty(u"QLineEditStyle", 1)

        self.formLayout_4.setWidget(0, QFormLayout.ItemRole.FieldRole, self.lineEdit_textPropertiesName)
        ...
        self.label_textProperties2.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(2, QFormLayout.ItemRole.LabelRole, self.label_textProperties2)
        ...
        self.doubleSpinBoxl_textPropertiesE.setDecimals(3)
        self.doubleSpinBoxl_textPropertiesE.setMinimum(0.001000000000000)
        self.doubleSpinBoxl_textPropertiesE.setMaximum(1000000.000000000000000)
        self.doubleSpinBoxl_textPropertiesE.setSingleStep(1.000000000000000)
        self.doubleSpinBoxl_textPropertiesE.setValue(1000.000000000000000)
        self.doubleSpinBoxl_textPropertiesE.setProperty(u"QDoubleSpinBoxStyle", 1)

        self.formLayout_4.setWidget(2, QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxl_textPropertiesE)
        ...
        self.label_textProperties3.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(3, QFormLayout.ItemRole.LabelRole, self.label_textProperties3)
        ...
        self.doubleSpinBoxl_textPropertiesV.setProperty(u"QDoubleSpinBoxStyle", 1)

        self.formLayout_4.setWidget(3, QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxl_textPropertiesV)
        ...
        self.label_textProperties4.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(4, QFormLayout.ItemRole.LabelRole, self.label_textProperties4)
        ...
        self.doubleSpinBoxl_textPropertiesC.setProperty(u"QDoubleSpinBoxStyle", 1)

        self.formLayout_4.setWidget(4, QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxl_textPropertiesC)
        ...
        self.label_textPropertiesColor.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(1, QFormLayout.ItemRole.LabelRole, self.label_textPropertiesColor)

        self.horizontalLayout_9 = QHBoxLayout()
        self.horizontalLayout_9.setSpacing(0)
        self.horizontalLayout_9.setObjectName(u"horizontalLayout_9")
        self.lineEdit_textPropertiesColor = QLineEdit(self.frame_4)
        self.lineEdit_textPropertiesColor.setObjectName(u"lineEdit_textPropertiesColor")
        self.lineEdit_textPropertiesColor.setEnabled(False)
        self.lineEdit_textPropertiesColor.setMinimumSize(QSize(120, 25))
        self.lineEdit_textPropertiesColor.setMaximumSize(QSize(16777215, 16777215))
        palette = QPalette()
...
#endif
        self.lineEdit_textPropertiesColor.setPalette(palette)
        self.lineEdit_textPropertiesColor.setStyleSheet(u"")
        self.lineEdit_textPropertiesColor.setProperty(u"QLineEditStyle", 2)

        self.horizontalLayout_9.addWidget(self.lineEdit_textPropertiesColor)

        self.toolButton_PropertiesColor = QToolButton(self.frame_4)
        self.toolButton_PropertiesColor.setObjectName(u"toolButton_PropertiesColor")
        icon2 = QIcon()
        icon2.addFile(u"app/resources/iconos/iconos_menu_draw_mesh/colo_picker.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_PropertiesColor.setIcon(icon2)
        self.toolButton_PropertiesColor.setIconSize(QSize(20, 20))
        self.toolButton_PropertiesColor.setArrowType(Qt.ArrowType.NoArrow)
        self.toolButton_PropertiesColor.setProperty(u"QToolButtonStyle", 1)

        self.horizontalLayout_9.addWidget(self.toolButton_PropertiesColor)
        ...
        self.doubleSpinBoxl_textPropertiesPhi.setProperty(u"QDoubleSpinBoxStyle", 1)

        self.formLayout_4.setWidget(5, QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxl_textPropertiesPhi)
        ...
        self.label_textProperties5.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(5, QFormLayout.ItemRole.LabelRole, self.label_textProperties5)
        ...
        self.doubleSpinBoxl_textPropertiesPsi.setStepType(QAbstractSpinBox.StepType.DefaultStepType)
        self.doubleSpinBoxl_textPropertiesPsi.setValue(5.000000000000000)
        self.doubleSpinBoxl_textPropertiesPsi.setProperty(u"QDoubleSpinBoxStyle", 1)

        self.formLayout_4.setWidget(6, QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxl_textPropertiesPsi)
        ...
        self.doubleSpinBoxl_textPropertiesP.setProperty(u"QSpinBoxStyle", 1)

        self.formLayout_4.setWidget(7, QFormLayout.ItemRole.FieldRole, self.doubleSpinBoxl_textPropertiesP)
        ...
        self.label_textProperties6.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(6, QFormLayout.ItemRole.LabelRole, self.label_textProperties6)
        ...
        self.label_textProperties4_2.setProperty(u"QLabelStyle", 3)

        self.formLayout_4.setWidget(7, QFormLayout.ItemRole.LabelRole, self.label_textProperties4_2)
        ...
        self.frame_properties1_1.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_properties1_1.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.toolButton_PropertiesCancel.setProperty(u"QToolButtonStyle", 3)
        ...
        self.toolButton_PropertiesCreateProperty.setProperty(u"QToolButtonStyle", 2)
        ...
        self.frame_propertiesSubTitle2.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_propertiesSubTitle2.setFrameShadow(QFrame.Shadow.Raised)
        ...
        self.label_cardPropertiesSubTitle2.setProperty(u"QLabelStyle", 2)

        self.horizontalLayout_7.addWidget(self.label_cardPropertiesSubTitle2)

        self.toolButton_showHideProperties = QToolButton(self.frame_propertiesSubTitle2)
        self.toolButton_showHideProperties.setObjectName(u"toolButton_showHideProperties")
        ...
        sizePolicy5.setHeightForWidth(self.toolButton_showHideProperties.sizePolicy().hasHeightForWidth())
        self.toolButton_showHideProperties.setSizePolicy(sizePolicy5)
        self.toolButton_showHideProperties.setMinimumSize(QSize(25, 25))
        self.toolButton_showHideProperties.setMaximumSize(QSize(25, 25))
        self.toolButton_showHideProperties.setFont(font)
        self.toolButton_showHideProperties.setStyleSheet(u"")
        icon3 = QIcon()
        icon3.addFile(u"app/resources/iconos/iconos_menu_draw_mesh/view.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolButton_showHideProperties.setIcon(icon3)
        self.toolButton_showHideProperties.setIconSize(QSize(15, 15))
        self.toolButton_showHideProperties.setToolButtonStyle(Qt.ToolButtonStyle.ToolButtonIconOnly)
        self.toolButton_showHideProperties.setProperty(u"QToolButtonStyle", 1)

        self.horizontalLayout_7.addWidget(self.toolButton_showHideProperties)
        ...
        self.toolButton_cardPropertiesSubTitle2.setArrowType(Qt.ArrowType.NoArrow)
        self.toolButton_cardPropertiesSubTitle2.setProperty(u"QToolButtonSubTitleStyle", 1)
        ...
        sizePolicy6.setHeightForWidth(self.frame_properties2.sizePolicy().hasHeightForWidth())
        self.frame_properties2.setSizePolicy(sizePolicy6)
        self.frame_properties2.setMinimumSize(QSize(0, 150))
        self.frame_properties2.setStyleSheet(u"")
        self.frame_properties2.setFrameShape(QFrame.Shape.StyledPanel)
        self.frame_properties2.setFrameShadow(QFrame.Shadow.Raised)
...
"border: none;")
    ...
    def retranslateUi(self, FormDrawMenuProperties):
        ...
        self.toolButton_showHideProperties.setText("")
