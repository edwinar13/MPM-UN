...
################################################################################
## Form generated from reading UI file 'widget_home_cardYjnqdS.ui'
##
...
class Ui_FormHomeCard(object):
    def setupUi(self, FormHomeCard):
        if not FormHomeCard.objectName():
            FormHomeCard.setObjectName(u"FormHomeCard")
        FormHomeCard.resize(533, 101)
        sizePolicy = QSizePolicy(QSizePolicy.Preferred, QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(FormHomeCard.sizePolicy().hasHeightForWidth())
        FormHomeCard.setSizePolicy(sizePolicy)
        FormHomeCard.setStyleSheet(u"/*Colores primarios*/\n"
"/* \n"
...
"border-radius: 5px\n"
"}")
        self.horizontalLayout_2 = QHBoxLayout(FormHomeCard)
        self.horizontalLayout_2.setSpacing(0)
        self.horizontalLayout_2.setObjectName(u"horizontalLayout_2")
        self.horizontalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.frame_card = QFrame(FormHomeCard)
        ...
        self.label.setPixmap(QPixmap(u"app/resources/iconos/iconos_frame_inicio/doc_mpm.svg"))
        ...
        sizePolicy3.setHeightForWidth(self.label_cardPath.sizePolicy().hasHeightForWidth())
        self.label_cardPath.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.label_cardDataTime.sizePolicy().hasHeightForWidth())
        self.label_cardDataTime.setSizePolicy(sizePolicy4)
        ...
        self.retranslateUi(FormHomeCard)

        QMetaObject.connectSlotsByName(FormHomeCard)
    # setupUi

    def retranslateUi(self, FormHomeCard):
        FormHomeCard.setWindowTitle(QCoreApplication.translate("FormHomeCard", u"Form", None))
        self.label.setText("")
        self.label_cardName.setText(QCoreApplication.translate("FormHomeCard", u"3 SIG 83 obras", None))
        self.label_cardPath.setText(QCoreApplication.translate("FormHomeCard", u"D:/Document/EjemD:/Document/EjemD:/Document/EjemD:/Document/Ejem", None))
        self.label_cardDataTime.setText(QCoreApplication.translate("FormHomeCard", u"25/02/2022 07:32:52 A.M.", None))
    # retranslateUi
