...
class ViewWidgetResultMenuTable(QFrame, Ui_FormMenuResultTable):
    ...
    signal_generate_pdf = Signal(str) 
    ...
    def __initEventUi(self):
        ...
        self.pushButton_GeneratePDF.clicked.connect(self.__clickedToolButtonGeneratePDF)
    ...
    def __clickedToolButtonGeneratePDF(self):
        #abrir dialogo para guardar pdf
        options = QFileDialog.Options()
        new_path_file, _ = QFileDialog.getSaveFileName(self,"Exportar datos","","Archivos PDF (*.pdf)", options=options)
        if new_path_file:
            self.signal_generate_pdf.emit(new_path_file)
    ###############################################################################
	# ::::::::::::::::::::         GETTERS Y SETTERS           ::::::::::::::::::::
	###############################################################################
