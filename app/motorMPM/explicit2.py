...
@njit(cache=True)#('Tuple((f8[:,:], f8[:,:], f8[:,:]))(i8[:], i8[:], i8[:], f8[:,:], f8[:,:], f8[:,:])')#, parallel=True)
...
@njit(cache=True)#('Tuple((f8[:,:], f8[:,:]))(i8[:], i8[:], i8[:], f8[:,:], f8[:,:])')#, parallel=True)
...
@njit(cache=True)#('f8[:,:](i8[:], i8[:], i8[:], f8[:,:])')#, parallel=True)
