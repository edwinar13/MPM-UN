...
from views.draw.view_PageDraw import  ViewPageDraw
from models.model_ProjectCurrent import ModelProjectCurrent

from controllers.controller_graphicsDraw import ControllerGraphicsDraw

from controllers.draw.controller_MenuData import ControllerMenuData
from controllers.draw.controller_MenuMesh import ControllerMenuMesh
from controllers.draw.controller_MenuPointMaterial import ControllerMenuPointMaterial
from controllers.draw.controller_MenuProperties import ControllerMenuProperties
from controllers.draw.controller_MenuBoundary import ControllerMenuBoundary
from controllers.draw.controller_MenuExecute import ControllerMenuExecute
import math
...
class ControllerPageDraw(QObject):
    ...
    @Slot(str)
    def newItemPointMaterialView(self, id_material):
        self.controller_menu_execute.newItemsListsMaterialPoint(id_material)
        
    @Slot(str)
    def newItemBoundaryView(self, id_boundary):
        self.controller_menu_execute.newItemsListsBoundaries(id_boundary)
