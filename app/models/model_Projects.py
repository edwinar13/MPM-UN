...
class ModelProjects:
    ...
    def createProjectFile(self, path_project):
        ...
        try:
            ...
            filePath = os.path.splitext(path_project)[0] + '.json'
            data = {}
            data['INFORMACION'] = {
                "NOMBREPROYECTO": "",
                "LOCALIZACION": "",
            ...
            data['MESH'] = {
                "MESHBACK": {
                    ...
                    "SIZEELEMENT": 1.0,
                    "NODES": {
                        "NODE#1": {"COORDINATES": [0.0, 0.0]},
                        "NODE#2": {"COORDINATES": [1.0, 0.0]},
                        "NODE#3": {"COORDINATES": [2.0, 0.0]},
                        "NODE#4": {"COORDINATES": [0.0, 1.0]},
                        "NODE#5": {"COORDINATES": [1.0, 1.0]},
                        "NODE#6": {"COORDINATES": [2.0, 1.0]},
                        "NODE#7": {"COORDINATES": [0.0, 2.0]},
                        "NODE#8": {"COORDINATES": [1.0, 2.0]},
                        "NODE#9": {"COORDINATES": [2.0, 2.0]}
                    },
                    "ELEMENTS": {
                        
                            "ELEMENT#1": ["NODE#1", "NODE#2", "NODE#5", "NODE#4"],
                            "ELEMENT#2": ["NODE#2", "NODE#3", "NODE#6", "NODE#5"],
                            "ELEMENT#3": ["NODE#4", "NODE#5", "NODE#8", "NODE#7"],
                            "ELEMENT#4": ["NODE#5", "NODE#6", "NODE#9", "NODE#8"]
                    },
                    
                    "NODESBOUNDARYTOP": ["NODE#7", "NODE#8", "NODE#9"],
                    "NODESBOUNDARYBOTTOM": ["NODE#1", "NODE#2", "NODE#3"],
                    "NODESBOUNDARYLEFT": ["NODE#1", "NODE#4", "NODE#7"],
                    "NODESBOUNDARYRIGHT": ["NODE#3", "NODE#6", "NODE#9"]
                    },
                "TRIANGULARES": {},
                "CUADRILATEROS": {}
                }
