...
################################################################################
## Form generated from reading UI file 'widget_result_menu_animationwCYlRp.ui'
##
...
"")
        ...
        icon2 = QIcon()
        icon2.addFile(u"recursos/iconos/icono_result/atras.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"recursos/iconos/icono_result/stop.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"recursos/iconos/icono_result/play.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"recursos/iconos/icono_result/adelante.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(u"recursos/iconos/iconos_menu_draw_mesh/colo_picker.svg", QSize(), QIcon.Normal, QIcon.Off)
